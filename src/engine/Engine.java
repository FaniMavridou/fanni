...
//			prefixes.add(l.get(2));
	...
	public int exportMarkDown(String outputFileName) {
		 ...
		 * System.out.println("Loaded: " + this.filePath + " to generate " + outputFileName); 
		...
		System.out.println("\n[Engine.loadProcessMarkup] [file: " + simpleInputFileName + "] exported as " + outputFileName +"\n Input #pars: " + this.lineblocks.size() + ", Output #pars: " + outputNumParagraphs);
	...
	public int exportPdf(String outputFileName) {
		...
		int outputNumParagraphs = exporter.export();
		System.out.println("\n[Engine.loadProcessPdf] [file: " + simpleInputFileName + "] Input #pars: " + this.lineblocks.size() + ", Output #pars: " + outputNumParagraphs);
	...
	public List<String> reportWithStats(){
		...
		if(numParagraphs==0)
			loadFileAndCharacterizeBlocks();
		report.add("Total number of paragraphs: " + numParagraphs + "\n");
		report.add("Total number of words: " + numWords + "\n");
		for(LineBlock lineblock: this.lineblocks) {
			report.add(lineblock.getStatsAsString());
			numWords += lineblock.getNumWords();
		}
		report.set(1, "Total number of words: " + numWords + "\n");
		return report;
	}
