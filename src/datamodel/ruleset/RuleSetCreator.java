...
public class RuleSetCreator {
	...
	public RuleSet createRuleSet() {
		...
		for(List<String> l: inputSpec) {
			...
			case "OMIT":	omitRule = currentRule;//System.out.println("OMIT: " + currentRule.toString());
						break;
			case "H1":	h1Rule = currentRule;//System.out.println("H1: " + currentRule.toString());
						break;
			case "H2":	h2Rule = currentRule;//System.out.println("H2: " + currentRule.toString());
						break;
			case "<B>":	boldRule = currentRule;//System.out.println("BOLD: " + currentRule.toString());
						break;
			case "<I>":	italicsRule = currentRule;//System.out.println("ITALICS: " + currentRule.toString());
						break;
